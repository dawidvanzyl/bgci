...
export const SORT_FIELDS = [
	...
	{ field: 'bggWeight',       label: 'Difficulty',  type: 'number',  defaultDir: 'asc'  },
	...
	{ field: 'minAge',          label: 'Age',         type: 'number',  defaultDir: 'asc'  },
	{ field: 'subdomains',      label: 'Subdomain',   type: 'string',  defaultDir: 'asc'  },
];
...
export let bggSearchEnabled = false;   // BGG search is configured and reachable
export let bggCollectionEnabled = false; // BGG collection sync is enabled
...
export function setBggSearchEnabled(val)      { bggSearchEnabled = val; }
export function setBggCollectionEnabled(val)  { bggCollectionEnabled = val; }
